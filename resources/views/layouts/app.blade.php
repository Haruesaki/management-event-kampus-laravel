    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar {
            ...
            height: 100vh; z-index: 100; padding: 24px 0;
        }
        .sidebar-brand {
            padding: 0 20px 28px;
        ...
        .nav-item {
            ...
            color: #ccc5e8; text-decoration: none;
        ...
        .nav-item.active {
            background: var(--accent-soft); color: #d89cff;
        ...
        .topbar-search input {
            ...
            font-family: 'DM Sans', sans-serif;
            font-size: 13px; color: var(--text-1); width: 160px;
        }
        ...
        .avatar {
            ...
            overflow: hidden; border: 2px solid var(--accent-glow);
        }
...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            {{-- Discovery --}}
            <a href="{{ route('user.events') }}" class="nav-item {{ request()->routeIs('user.events') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
