...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="../users/index.blade.php" class="nav-item">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="../events/index.blade.php" class="nav-item active">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <a href="../users/bulk.blade.php" class="nav-item">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="sidebar-footer">
      <div class="admin-card">
        <div class="admin-avatar">AT</div>
        <div class="admin-info">
          <div class="name">Alex Thorne</div>
          <div class="role">System Lead</div>
        </div>
      </div>
    </div>
  </aside>
